...
#
# Script generated by Vivado on Thu Dec 07 18:22:45 +0100 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : blk_mem_ROM.sh
...
#
# Usage        : blk_mem_ROM.sh
#                blk_mem_ROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_ROM.sh [-reset_run]
#                blk_mem_ROM.sh [-reset_log]
#                blk_mem_ROM.sh [-help]
#
...
# script info
echo -e "blk_mem_ROM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_ROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_ROM xil_defaultlib.blk_mem_ROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_ROM -key {Behavioral:sim_1:Functional:blk_mem_ROM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blk_mem_ROM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_mem_ROM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_mem_ROM.sh [-help]\n\
Usage: blk_mem_ROM.sh [-step]\n\
Usage: blk_mem_ROM.sh [-lib_map_path]\n\
Usage: blk_mem_ROM.sh [-reset_run]\n\
Usage: blk_mem_ROM.sh [-reset_log]\n\
Usage: blk_mem_ROM.sh [-keep_index]\n\
Usage: blk_mem_ROM.sh [-noclean_files]\n\n\
